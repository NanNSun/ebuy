...
<%
 ...
 <center>
	...
	<%
			...
			{
					out.println( "<HTML><HEAD><META http-equiv='refresh' content='2; URL=admin/index.jsp' target=Main></HEAD><BODY bgcolor='#FFFFFF'></body></html>");
		%>
		<br /><br /><br /><br /><br /><br /><br /><br />
 <center>
	  <table width="300" border="1" bordercolor="#99CCFF" style="border-collapse:collapse" cellpadding="0" cellspacing="0">
	...
	<%
		...
		{
			out.println("<script language='javascript'>alert('您的操作有误!');window.location.href='admin/default.jsp';</script>");
		}
	}
%>
