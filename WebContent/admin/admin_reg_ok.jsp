...
<%
	...
	if (name != null || email != null) {
		String sql = "INSERT INTO admin VALUES('" + name + "','" + pass + "','" + image + "','" + phone + "','"
				+ email + "')";
		int temp = conn.doUpdate(sql);
		if (temp == 0) {
			out.println(
					"<HTML><HEAD><META http-equiv='refresh' content='1; URL=admin_reg.jsp' target=Main></HEAD><BODY bgcolor='#FFFFFF'></body></html>");
